...
def load_cifar10(args):
    ...
    dataset = datasets.CIFAR10(DATA_PATH, train=True, download=True, transform=transform_train)
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.CIFAR10(DATA_PATH, train=False, transform=transform_test),
        batch_size=1,
        shuffle=True,
        num_workers=1
    )
...
# Split function
def split_cifar10(args,train_loader,global_loader=None):
    """ The split function
